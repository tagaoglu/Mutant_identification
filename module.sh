export PATH=/data/users/tagaoglu/BC7107_20/scripts:/software/bin:/usr/local/bin:$PATH;
...
export PATH=/data/users/tagaoglu/BC7107_20/scripts/hifiasm:/data/users/tagaoglu/BC7107_20/scripts/Flye-2.8-1/bin:$PATH
